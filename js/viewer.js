			...
			window.parent.OCA.FilesMindMap.load(function(data){
                ...
                if (data !== ' ') {
                    try {
                        ...
                        alert('This file is not a valid mind map file and may cause file corruption if you continue editing！');
                    }
                }
				...
				alert('Loading the file failed!' + msg);
